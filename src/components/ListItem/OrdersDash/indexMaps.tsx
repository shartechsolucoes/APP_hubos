...
export default function ListItemOrders({
	...
	return (
		<>
			<div className="card-orders" onClick={onClick} style={{ cursor: "pointer" }}>
				<div className="row px-4 py-3">
					<div className="col-12 col-sm-12 col-md-12 d-flex justify-content-between align-items-center">
						<a href="">
							<span className="text-os">#{qrcode}</span>
						</a><Status statusOS={status} />
					...
					<div className="col-sm-12 col-md-12 d-flex flex-column justify-content-start align-items-start">
						<div className="d-flex flex-column">
					...
					<div className="d-none d-md-flex col-md-12 d-flex justify-content-end align-items-center action">
						{accessLevel === 2 ||
							(accessLevel === 0 && (
