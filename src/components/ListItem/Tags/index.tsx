						...
						<div className="d-flex justify-content-start align-items-center">
							<div className="avatar-wrapper">
								<div className="avatar avatar-sm me-3">
									<span className="avatar-initial rounded-circle bg-label-dark ">QR</span>
								</div>
							</div>
							<div className="d-flex flex-column">
								<span
									className="fw-medium">N° QR Code</span>
							</div>
						</div>
					</div>
					<div className="col-sm-4 col-md-4 d-flex justify-content-start align-items-center">
						<a href="app-ecommerce-order-details.html"><span>Data</span></a>
					</div>
