	...
	return (
		<div className="mb-6">
			<div className="card-body pt-12">
					...
					<div className=" d-flex align-items-center flex-column">
						{avatar || formData.picture ? (
							<div className="user-image">
								<label className="btn btn-upload" htmlFor="avatar-upload">
									Inserir Foto
								</label>
							<img
								className=""
				...
				<h5 className="border-bottom mt-4">Detalhes</h5>
				<div className="info-container">
					<ul className="list-unstyled mb-6">
						<li className="mb-2">
							<span className="h6">Usuário:</span>
